...
<div id="w0-container" class=" tabs-above tab-align-left tab-bordered tab-height-lg tabs-krajee">
  <ul id="w0" class="nav nav-tabs nav nav-tabs hidden-print" data-krajee-tabsX="tabsX_00000000" role="tablist">
    <li><a href="index.php?r=fb-booking-booked"><i class="fa fa-ticket"></i> Current + Future Bookings</a></li>
    <li class="active"><a><i class="fa fa-ticket"></i> Past Bookings</a></li>
  </ul>
</div>

<?php //= Html::a('Export Old Calendar', ['ics' , 'id' => 1], ['class'=>'btn btn-primary']) ?>
</br>
            <?php Box::begin(
                [

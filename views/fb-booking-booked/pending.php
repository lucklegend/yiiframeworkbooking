        ...
        'columns' => [
           ...
           // 'slot_from',
			...
			'value' => function($dataProvider){
				...
				//if(date("Y-m-d H:m:s", strtotime('-24 hours', $dataProvider->slot_from))){

				if(strtotime($dataProvider->slot_from) >= strtotime('-1 day')){

					return Html::a('Cancel', ['usercancel'], ['data-pjax' => 0]);

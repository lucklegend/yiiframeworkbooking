 ...
 --> 
  ...
  <div class="col-sm-2">
    <div class="col-sm-2" style="text-align:left;"> 
    	<a href="index.php?r=facilities/walkthrough" style="padding: 10px;opacity: inherit;background-color: #ff000000;"><img src="img/rgtvirtual.jpg" width="163" height="132" border="0"></a><br>
...
<!--   
  ...
  <div class="col-sm-2" style="text-align:right"> <a href="" style="padding: 10px;opacity: inherit;background-color: #ff000000;"><img src="img/rgtvirtual.jpg" width="163" height="132" border="0"></a><br>
    <a href="index.php?r=gallery%2Fgallery%2Findex" style="padding: 10px;opacity: inherit;background-color: #ff000000;"><img src="img/rgtphotol.jpg" width="163" height="141" border="0"></a><br>
    <a href="index.php?r=fb-booking-group%2Fsite" style="padding: 10px;opacity: inherit;background-color: #ff000000;"><img src="img/rgtplan.jpg" width="163" height="137" border="0"></a> </div>
  <!-Bottom Div--> 

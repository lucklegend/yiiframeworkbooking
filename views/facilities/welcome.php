...
<!--
  <div class="col-sm-2" style="text-align:right"> 
    ...
    <a href="index.php?r=fb-booking-group%2Fsite" style="padding: 10px;opacity: inherit;background-color: #ff000000;"><img src="img/rgtplan.jpg" width="163" height="137" border="0"></a> 
  </div>
-->
  <!--Bottom Div--> 

...
<body class="mainCheck">
    ...
    <div class="container" style="height: 80px;">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="https://ardmorepark.com.sg/site/">
          ...
          ?>
          <!-- LOGO -->
          <img class="img-responsive" id="hdimg" src="img/ard-more-park-logo.png">
        </a>
      </div>
  ...
  <?= Alert::widget(); ?>
  <div class="container-in-container" style="background-color:#FDF5E1;">
    <!-- //FDF5E1 C8BC9B -->
    ...
    <div class="container" style="background:none">
      ...
      <div class="row">
        <div class="col-sm-12 footer-item">
          <hr id="footerline">
          <p style="color:white;">
            © Copyright Ardmorepark. Managed by Knight Frank Property Asset Management Pte Ltd | Powered by <a href="https://axon.com.sg/" target="_blank" style="color:white;"> Axon Consulting </a>
          </p>
        </div>
      </div>
    </div>

...
class Module extends \vova07\base\components\Module
{
     ...
     */
    public $previewUrl = '../statics/web/blogs/previews';

    /**
     * @var string Image URL
     */
    public $imageUrl = '../statics/web/blogs/images';

    /**
     * @var string Files URL
     */
    public $fileUrl = '../statics/web/blogs/files';

    /**
     * @var string Files URL
     */
    public $contentUrl = '../statics/web/blogs/content';
